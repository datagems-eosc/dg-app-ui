...
export const mockFilePreviewData: Record<string, FilePreviewData> = {
  "file1-csv": {
    ...
    columns: [
      { id: "station_id", name: "station_id", type: "text", visible: true },
      { id: "location", name: "location", type: "text", visible: true },
      { id: "temperature", name: "temperature", type: "number", visible: true },
      {
        id: "precipitation",
        name: "precipitation",
        type: "number",
      ...
      { id: "humidity", name: "humidity", type: "number", visible: true },
      { id: "wind_speed", name: "wind_speed", type: "number", visible: true },
      { id: "pressure", name: "pressure", type: "number", visible: true },
      { id: "date", name: "date", type: "date", visible: true },
    ],
